...
Element cover_lock_element(COVER_LOCK_OUT_PIN, true, true);

Element pressure_solenoid_l_element(PRESSURE_SOLENOID_L_OUT_PIN, true, true);
Element pressure_solenoid_r_element(PRESSURE_SOLENOID_R_OUT_PIN, true, true);
